...
function worldCupTrophyIcon() {
  return `
    <svg class="trophy-icon" viewBox="0 0 64 64" aria-hidden="true" focusable="false">
      <defs>
        <linearGradient id="broadcastTrophyGold" x1="16" y1="10" x2="49" y2="55" gradientUnits="userSpaceOnUse">
          <stop offset="0" stop-color="#fff2a6"/>
          <stop offset="0.42" stop-color="#f7c957"/>
          <stop offset="1" stop-color="#b97816"/>
        </linearGradient>
        <linearGradient id="broadcastTrophyGreen" x1="24" y1="42" x2="44" y2="62" gradientUnits="userSpaceOnUse">
          <stop offset="0" stop-color="#37f3a4"/>
          <stop offset="1" stop-color="#0b9b63"/>
        </linearGradient>
      </defs>
      <path d="M32 7c7 0 13 4.8 13 12.4 0 6.3-3.8 10.5-8.2 14 3.8 1.6 6.4 5.2 6.4 9.4 0 4.9-3.6 9.1-8.6 10.1v3.5h11.1v4.4H18.3v-4.4h11.1v-3.5c-5-1-8.6-5.2-8.6-10.1 0-4.2 2.6-7.8 6.4-9.4-4.4-3.5-8.2-7.7-8.2-14C19 11.8 25 7 32 7Z" fill="url(#broadcastTrophyGold)"/>
      ...
      <path d="M28.2 48.2h7.6l2.8 8.2H25.4l2.8-8.2Z" fill="url(#broadcastTrophyGreen)"/>
    ...
    <section class="broadcast-frame">
      <div class="brand-panel">
        <div class="brand-title">
          <span class="brand-mark" role="img" aria-label="World Cup trophy">${worldCupTrophyIcon()}</span>
          <div>
            <h1>Jaco 官方文字直播</h1>
